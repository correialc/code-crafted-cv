...
\cventry
{Python Backend Engineer} % Job title
...
\begin{cvitems}
	...
	\item{Core technologies: Python, REST-API, GraphQL, CI/CD, AWS, Microservices, SQL and Neo4J.}
\end{cvitems}
}
...
\begin{cvitems}
	...
	\item{Core skills: Python, REST-API, Airflow, MongoDB, CI/CD, AWS, NumPy, Pandas, NLP, Apache Lucene, Java.}
\end{cvitems}
}
...
\cventry
{Database Team Leader} % Job title
{INDRA} % Organization
{Salvador, Brazil} % Location
